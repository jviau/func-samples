...
{
    public static (TFirst First, TSecond Second) GetArguments<TFirst, TSecond>(this CustomAttribute attribute)
    {
        ...
        TFirst first = (TFirst)attribute.ConstructorArguments[0].Value;
        TSecond second = (TSecond)attribute.ConstructorArguments[1].Value;
        return (first, second);
    }
